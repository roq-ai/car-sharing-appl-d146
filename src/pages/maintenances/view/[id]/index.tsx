...
import { useMaintenanceFindFirst, useRoqClient } from 'lib/roq';
...
function MaintenanceViewPage() {
  ...
  const queryParams = useMemo<{ include: { car: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useMaintenanceFindFirst(queryParams, {}, { disabled: !id });
