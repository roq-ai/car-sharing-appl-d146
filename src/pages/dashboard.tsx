...
import { useRoqPlatformUserProfiles, useCarCount, useMaintenanceCount, useBookingCount } from 'lib/roq';

import { MaintenanceListPage as ShowCaseList } from 'pages/maintenances';
...
function DashboardPage() {
  ...
  const maintenanceStat = useMaintenanceCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Maintenances',
      result: maintenanceStat?.data,
      isLoading: maintenanceStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Bookings',
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`maintenances`} passHref legacyBehavior>
                  <Button
